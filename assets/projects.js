    ...
    validation: [
      {
        title: "백엔드 테스트 실행 결과",
        detail:
          "Spring Boot 백엔드 테스트는 Java 17 환경에서 약 91% 범위를 검증했습니다. 외부 키와 환경변수 값이 필요한 Spring context, CafeService 통합성 테스트는 별도 실행 환경이 필요한 항목으로 분리했습니다.",
      },
      {
        title: "카페 도메인 테스트 보강",
        detail:
    ...
    validation: [
      {
        title: "전체 테스트 실행 결과",
        detail:
          "Java 21 환경에서 Gradle 테스트 기준 100% 검증을 완료했습니다. 장바구니, 알림, 주문, 배송지, 상품, 인증, 관리자 기능이 테스트 대상에 포함됩니다.",
      },
      {
    ...
    validation: [
      {
        title: "전체 테스트 실행 결과",
        detail:
          "Java 17 환경에서 전체 테스트 기준 약 96% 범위를 검증했습니다. Redis 인프라가 필요한 Feed/FCM 통합 테스트는 로컬 실행 조건을 분리해 관리했습니다.",
      },
      {
        title: "기능별 테스트 보강",
        detail:
    ...
    validation: [
      {
        title: "전체 테스트 실행 결과",
        detail:
          "Java 17 환경에서 Gradle 테스트 기준 100% 검증을 완료했습니다. 웨이팅 서비스, Redis 서비스, 비동기 큐 프로세서 테스트가 포함됩니다.",
      },
      {
